...
export const DelDepartment = ({ setDelDept, setGData, deptId }) => {
    ...
    <div className={`${styles.container} flex items-center justify-center`}>
      <div className="w-full max-w-2xl mx-auto bg-gray-50 rounded shadow p-6">
        <div className="flex justify-between mb-5">
          <h1 className="font-semibold">Remove Department</h1>
          <FontAwesomeIcon
            icon={faTimes}
            onClick={() => setDelDept(false)}
        ...
        <div>
          <h3 className="text-xl">
            Are your sure you want to delete this department?
          </h3>
          <p className="text-red-600 text-sm font-bold">
            All employees will be deleted
          </p>
        ...
        <div className="mt-5 flex justify-end gap-4">
          <button
            onClick={() => setDelDept(false)}
            className="bg-red-600 hover:bg-red-700 text-gray-50 p-2 rounded"
          >
            Cancel
          </button>
